...
\usepackage{url}            % url citation with its setting
...
\def\ThesisTitle{Adversarial Examples Generation\\[2mm] for~Deep Neural Networks}

% Author of the thesis
\def\ThesisAuthor{Štěpán Procházka}
...
\def\Dedication{%
To whom it may concern, Thank You. % TODO center ??
}
...
\def\Keywords{%
{machine learning} {adversarial examples} {evolutionary algorithms} {deep learning}
}
